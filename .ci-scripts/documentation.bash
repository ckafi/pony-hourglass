...
BUILD_DIR="build/hourglass-docs"
DOCS_DIR="${GEN_MD}/hourglass/${TAG}"
...
branch_name="hourglass-${TAG}"
git checkout -b "${branch_name}"
echo "Adding content..."
git add .
git commit -m "Add docs for package: hourglass version: ${TAG}"
